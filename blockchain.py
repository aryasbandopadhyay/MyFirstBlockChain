...
# function to create blocks    
    ...
    def get_previous_block(self):
        return self.chain[-1]
# fn to find proof to add new block    
...
def mine_block():
    ...
    response={'message':'Congrats','index':block['index'],'timeStamp':block['timeStamp'],
...
def is_valid():
    ...
    if is_valid == True:
        ...
        response={'message':'No, the chain is invalid'}
